...
function envoyerBien($connexion, $login, $superficieBien, $superficieTerrain, $prixHfai, $nbPiece, $numAppartement, $nombreChambre, $ville, $codepostal){
    if(isset($_POST['VILLE']) && ($_POST['CODEPOSTAL']) && isset($_POST['SUPERFICIE_BIEN']) && isset($_POST['SUPERFICIE_TERRAIN']) && isset($_POST['PRIX_HFAI']) /**&& isset['PHOTOS']*/ && isset($_POST['NOMBRE_DE_PIECE']) && isset($_POST['NUM_APPARTEMENT']) && isset($_POST['NOMRE_DE_CHAMBRE'])){
...
$req=$db->query("INSERT INTO BIEN (SUPERFICIE_BIEN, SUPERFICIE_TERRAIN, PRIX_HFAI, NOMBRE_DE_PIECE, NUM_APPARTEMENT, NOMBRE_DE_CHAMBRE, VILLE, CODEPOSTAL) VALUES ('$superficieBien','$superficieTerrain','$prixHfai','$nbPiece','$numAppartement','$nombreChambre','$ville','$codepostal')");